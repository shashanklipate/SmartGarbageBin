...
public class WorkerDashboard extends AppCompatActivity
    ...
    private CardView profileId,statusId,addId,newupdatesId,demoId;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_worker_dashboard);

        profileId =(CardView)findViewById(R.id.workerprofileId);
        statusId =(CardView)findViewById(R.id.statusId);
        addId =(CardView)findViewById(R.id.addId);
        newupdatesId =(CardView)findViewById(R.id.newupdatesId);
